...
同人活動を行うにあたって、一つ忘れてはいけないのが、税金の絡みです。確定申告が必要なラインは案外しきい値低いので、注意が必要です。（Text：親方）
...
したがって、本節では最も簡単に、かつ無料できる、国税庁の確定申告Webシステム「e-tax」@<fn>{taxSys}を利用し、申告書を作成し、郵送により申告する方法について述べます。
